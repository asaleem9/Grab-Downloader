...
Grab's privacy policy is simple: we don't collect or store anything about you.
what you do is solely your business, not ours or anyone else's.

these terms are applicable only when using the official Grab instance.
...
when using saving functionality, Grab may need to proxy or remux/transcode files.
...
on an unmodified & official Grab instance,
...
of active Grab users, fully anonymously. no identifiable information about
you or your requests is ever stored. all data is anonymized and aggregated.
we self-host and manage the [plausible instance](https://{env.PLAUSIBLE_HOST}/) that Grab uses.
